...
public class ModItems
{
    ...
    public static final DeferredItem<BucketItem> QUICKSAND_BUCKET = ITEMS.register("quicksand_bucket",
            () -> new BucketOfQuicksandItem(ModBlocks.QUICKSAND.get(), new Item.Properties()));
